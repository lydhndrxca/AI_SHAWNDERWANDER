  ...
  golf_talk: [
    ...
    },
    {
      ...
      variants: {
        ...
        4: '"From where I\'m standing, that\'s got at least two cups of break. And it\'s faster than it looks — the grain runs toward the ocean."',
  ...
  banter: [
    {
      ...
      senderText: 'Hey, at least the ocean didn\'t get it.',
      statKey: 'humor',
      variants: {
        ...
        3: '"Hey, at least the ocean didn\'t get it." A serviceable joke. Brief smile.',
        ...
        5: '"Listen, I once hit a ball so far right on this hole that it ended up on a kayaker\'s lap in the cove. He threw it back. I played it. Still made bogey." They\'re doubled over laughing. The tension is gone.',
      },
    },
    {
      id: 'joke_bet',
  ...
  encouragement: [
    ...
    },
    {
      ...
      variants: {
        ...
        4: '"Listen — that hole is a beast. Everyone struggles there. Fresh start on the next tee. The ocean doesn\'t keep score."',
  ...
  clubhouse: [
    {
      id: 'club_cheers',
      label: 'RAISE A GLASS',
      senderText: 'Cheers — to a great day at Pebble Beach.',
      statKey: 'swagger',
      variants: {
        1: 'They raise their glass too fast, spill a little, and say "To... golf?" while wiping their hand on their pants.',
        2: '"Cheers! To, um, Pebble Beach! And golf! And us being here!" Too many things. Pick one.',
        3: '"Cheers — to a great day at Pebble Beach." Glasses clink. Simple and nice.',
        4: '"To Pebble Beach. To the Pacific. And to playing golf with people who actually appreciate what this place is." Clink. That felt like a moment.',
        5: '"Hold on." They pause, look out the window at the ocean, then back at you. "Cheers — to the fact that we\'re alive, we\'re here, and we just played one of the most beautiful courses on Earth. Everything after this is a bonus." You want to frame this moment.',
      },
    },
    {
      id: 'club_rematch',
