    ...
    perks: [
      {
        ...
        tier: 1,
        slot: 'A',
        description: 'Dave impression gains from all sources increased by 50%.',
  ...
  humor: {
    ...
    perks: [
      ...
      },
      {
        ...
        tier: 3,
        slot: 'A',
        description: 'Dave gives you a shot tip each hole: random −0.3 bonus.',
  ...
  zen: {
    ...
    perks: [
      ...
      },
      {
        ...
        flavor: 'You hear the waves. They\'re saying: relax.',
